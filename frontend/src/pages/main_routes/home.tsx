...
const Home = () => {
    return (
        <div>
            ...
            <video src="./video/test.mkv" autoPlay muted loop controls={false} className="w-full h-[85vh] object-cover"></video>
            ...
            <div className="mt-10 w-full h-auto flex flex-col gap-4">
                <h1 className="font-inter text-[42px] font-semibold px-24 w-full text-navy-blue">LANDMARKS</h1>
