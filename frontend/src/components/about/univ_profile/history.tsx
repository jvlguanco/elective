const History = () => {
    return(
        <div className="w-full pt-8 pr-12">
            ...
            <img src="/images/background.jpg" alt="" className="w-full h-96 object-cover" />
