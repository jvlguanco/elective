...
const ConsolidatedUpdates = () => {
    ...
    const openModal = (item: UpdateItem | null = null) => {
        if (item) {
            setFormData({
                id: item.id,
                title: item.title,
    ...
    return (
        <>
            <div className="w-full flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold">Consolidated Updates</h2>
                <button
                    onClick={() => openModal()}
            ...
            {loading ? (
                ...
                <div className="mb-6">
                    <table className="table-auto w-full border-collapse border border-gray-200">
                        ...
                        <tbody>
                            {displayItems(updates.items, page).map((item, index) => (
...
export default ConsolidatedUpdates;